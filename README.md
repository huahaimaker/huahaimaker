...
- **长期主线：** 青年成长 × AI 实战 × 真实行动

## 精选开源作品

这些项目都具备清晰的使用入口、公开源码和可核验的交付状态。
...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        <strong>已交付：</strong>Obsidian 官方社区插件<br>
        <a href="https://community.obsidian.md/plugins/bloomtype-publisher">安装</a> ·
        <a href="https://mp.autoaihub.cn">在线体验</a>
      </p>
    </td>
    <td width="50%" valign="top">
...
- 用户能不能找到明确的安装或体验入口
- README 有没有说清楚能力、限制和安全边界
- Release、测试或真实运行截图能不能支撑项目状态
- 别人是否容易提交 Issue、参与改进或复用其中的能力

常用技术包括 `Swift / SwiftUI / AppKit`、`TypeScript / Obsidian`、`Python / Agent Orchestration`，以及 `WinUI / Tauri / Rust`。
